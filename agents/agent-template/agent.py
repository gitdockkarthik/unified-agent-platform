...
class AgentRunner:
    """Stateless Claude invocation wrapper with optional tool-use loop.

    Construct once at startup with a list of ToolExecutor instances.
    Call run() per request — no instance state is mutated between calls.
    """
    ...
    async def run(
        ...
        """Invoke Claude, handling the tool-use loop automatically.
